...
public class CategoryChooseTab2 extends SherlockListFragment {
	...
	private void initView() {	
		...
		List<TableCategory> categoryList = db.getAllExpenseCategories(MoneyAppDatabaseHelper.GET_ALL_EXPENSE);
